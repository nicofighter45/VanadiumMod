...
public class ModBlocksItem {
    ...
    public static final BlockItem MAMADE_BLOCK_ITEM = new BlockItem(ModBlocks.MAMADE_BLOCK, settings);
    ...
    public static final BlockItem PIPE_BLOCK_ITEM = new BlockItem(ModMachines.PIPE_BLOCK, settings);
    ...
    public static void registerAll() {
        ...
        registerNewItemBlock("mamade_block_item", MAMADE_BLOCK_ITEM);
        ...
        registerNewItemBlock("pipe_block_item", PIPE_BLOCK_ITEM);
    }
