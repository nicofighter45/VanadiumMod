    ...
    public static void generateOres(){
        ...
        ConfiguredFeature<?, ?> VANADIUM_ORE_GENERATION = Feature.ORE
                .configure(new OreFeatureConfig(
                        ...
                        4))
                .decorate(Decorator.RANGE.configure(new RangeDecoratorConfig(ConstantHeightProvider.create(YOffset.belowTop(100)))))
                .spreadHorizontally()
                .repeat(1);
        ...
        RegistryKey<ConfiguredFeature<?, ?>> copper_ore = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY,
