    ...
    public static void registerAll(){
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            if(keybinding_fire_protection.isPressed()){
                ...
                }else if(player.getInventory().getArmorStack(3).getItem() == ModItems.STEAM_HELMET &&
                        player.getInventory().getArmorStack(2).getItem() == ModItems.STEAM_CHESTPLATE &&
                        player.getInventory().getArmorStack(1).getItem() == ModItems.STEAM_LEGGINGS &&
                        player.getInventory().getArmorStack(0).getItem() == ModItems.STEAM_BOOTS){
                    if(!player.hasStatusEffect(StatusEffects.SLOWNESS)){
